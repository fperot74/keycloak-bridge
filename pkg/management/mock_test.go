...
//go:generate mockgen -destination=./mock/component.go -package=mock -mock_names=Component=ManagementComponent,KeycloakClient=CompKeycloakClient,EventsReader=EventsReader github.com/cloudtrust/keycloak-bridge/pkg/management Component,KeycloakClient,EventsReader
