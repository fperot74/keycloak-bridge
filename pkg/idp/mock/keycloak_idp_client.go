...
// AddUserAttribute mocks base method.
func (m *Component) AddUserAttribute(ctx context.Context, realmName, userID, attributeKey, attributeValue string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddUserAttribute", ctx, realmName, userID, attributeKey, attributeValue)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddUserAttribute indicates an expected call of AddUserAttribute.
func (mr *ComponentMockRecorder) AddUserAttribute(ctx, realmName, userID, attributeKey, attributeValue any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddUserAttribute", reflect.TypeOf((*Component)(nil).AddUserAttribute), ctx, realmName, userID, attributeKey, attributeValue)
}
...
func (m *Component) DeleteUserAttribute(ctx context.Context, realmName, userID, attributeKey string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUserAttribute", ctx, realmName, userID, attributeKey)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteUserAttribute indicates an expected call of DeleteUserAttribute.
func (mr *ComponentMockRecorder) DeleteUserAttribute(ctx, realmName, userID, attributeKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUserAttribute", reflect.TypeOf((*Component)(nil).DeleteUserAttribute), ctx, realmName, userID, attributeKey)
}
